...
CONCURRENCY = int(_get("CONCURRENCY", os.getenv("CONCURRENCY", "2")))
MAX_RETRIES = int(_get("MAX_RETRIES", os.getenv("MAX_RETRIES", "7")))
INITIAL_BACKOFF = float(_get("INITIAL_BACKOFF", os.getenv("INITIAL_BACKOFF", "3.0")))
...
RESPONSE_CHUNK_SIZE = int(_get("RESPONSE_CHUNK_SIZE", 64 * 1024))
